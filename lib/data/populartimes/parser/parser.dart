...
class PopularTimesParser {
  static ParserCache cache = new ParserCache();
  http.Client _client;

  PopularTimesParser({http.Client httpClient}) {
    this._client = httpClient ?? http.Client();
  }

  /// Returns popularity statistics associated to a given place.
  /// Main method of this parser.
  Future<PopularTimes> getPopularTimes(Favorite place) async {
  ...
  Future<String> getFile (Favorite place) async {
