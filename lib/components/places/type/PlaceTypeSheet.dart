...
class PlaceTypeSheet extends StatefulWidget {
  final Function onTypeUpdated;
  final BuildContext context;
  PlaceTypeSheet({this.onTypeUpdated, this.context});

  @override
  _PlaceTypeSheetState createState() => _PlaceTypeSheetState();
}

class _PlaceTypeSheetState extends State<PlaceTypeSheet> {
  ...
  Widget build(BuildContext context) {
    return DraggableScrollableSheet(
      ...
      builder: (BuildContext localContext, ScrollController scrollController) {
            ...
            title: Center(
              child: Column (
                children: <Widget>[
                  ...
                  Container (
                    child: Text(FlutterI18n.translate(widget.context, "places_typepicker_title"), style: TextStyle(
        ...
        for (PlaceType t in PlaceType.getSortedTypes(widget.context)) {
          typesItems.add(
              ListTile(
